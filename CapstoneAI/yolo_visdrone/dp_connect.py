...
import sys
import time
dfcsURL = 'https://ied.dfcs.com/capstone/scripts/'
...
#statement = "SELECT DATA_TYPE FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'bombs' AND COLUMN_NAME='x'"
#statement = 'SELECT * FROM bombs'
#query_db(statement, 'SELECT', True)

#delete(3)
#insert_latlon(39.008935,-104.882653)
#insert_latlon(39.009057, -104.882140)
#insert_latlon(39.008884, -104.881700)
#insert_latlon(39.009061, -104.881276)
#insert_latlon(39.009255, -104.881712)
#updateXY(39.006911, -104.888816)
...
#delete(13)
#delete(14)
#print(query_db('SELECT MAX(ID) from bombs', 'SELECT'))
